...
const TAP_MAX_MOVEMENT = 2; // px — below this, a pointerup counts as a tap not a drag
...
export default function Flashcards({ deck, onDone }: Props) {
    ...
    const reviewed = index; // number of cards already swiped past
    ...
    const commitSwipe = useCallback(
        (direction: "known" | "learning") => {
            ...
            setTimeout(() => {
                setFlipped(false);
                // Swap to the next card and clear drag/exit state in the same tick,
                // BEFORE the card is allowed to transition again — prevents the
                // new card from inheriting the old transform and animating back in.
        ...
        <div className={styles.page}>
            ...
            <div className={styles.wrapper}>
                ...
                <div className={styles.stage} ref={stageRef}>
                    <div
                        ref={sceneRef}
                        className={`${styles.cardScene} ${flipped ? styles.flipped : ""} ${dragging || skipTransition ? styles.draggingScene : styles.settlingScene
                            }`}
